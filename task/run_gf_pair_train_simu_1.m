function run_gf_pair_train_simu_1()
...
% whether or not to allow fixations to be disjoint in time
allow_non_overlapping_acq = true;
...
task_params.allow_non_overlapping_acq = allow_non_overlapping_acq;
...
%   [res, acquired_m1,acquired_m2]
  [trial_rec.fixation_with_block_rule, acquired_m1,acquired_m2, m1_m2_overlapped_successfully] = state_fixation_with_block_rule();
...
function [res, acquired_m1,acquired_m2, achieved_required_overlap] = state_fixation_with_block_rule()
  ...
  [fs_m1, fs_m2, achieved_required_overlap] = joint_fixation2( ...
    @time_cb, loc_draw_cb ...
    ...
    , 'allow_non_overlapping_acq', allow_non_overlapping_acq ...
  );
