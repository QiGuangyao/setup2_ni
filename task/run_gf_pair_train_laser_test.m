function run_gf_pair_train_laser_test()
...
enbale_fixation_with_block_rule = false;
timing.initial_fixation_duration_m1 = 0.10;
timing.initial_fixation_duration_m2 = 0.10;
...
timing.gaze_delay_reward_m1 = 0.55;
timing.gaze_delay_reward_m2 = 0.0;
timing.gaze_delay_reward_m1_m2 = 0.0;
timing.gaze_delay_fixation_time = 0.25;


% 4 spatial cue
enable_spatial_cue = true;
timing.spatial_cue_state_duration = 5;
timing.spatial_cue_state_chooser_duration = 0.3;
timing.spatial_cue_reward_m1 = 0.2;
timing.spatial_cue_reward_m2 = 0.2;
...
timing.enable_gaze_triggered_actor_choice_reward_m2 = 0.45; % @TODO
timing.enable_gaze_triggered_actor_choice_reward_m1 = 1; % @TODO
...
timing.actor_response_state_duration =2;%--1.6
timing.actor_response_state_chooser_duration = 0.10;%--0.30
...
fix_cross_visu_angl = 3;%deg
visanglex = fix_cross_visu_angl;
visangley = fix_cross_visu_angl;
totdist_m1 = 450;%mm
totdist_m2 = 505;%mm
screen_height_left = 7;% cm after monitor down 
...
task_params.break_on_m1_first_choice = break_on_m1_first_choice;
...
%       deliver_reward( task_interface, 0, timing.init_reward_m1_m2);
  ...
  %}
  % select gaze trial
  trial_desc.is_gaze_trial = false; % true just for gaze trials at current stage
...
%     end
  ...
  if ( enable_gaze_triggered_delay && acquired_m1)% && rand() < trial_desc.prob_gaze_triggered_delay )
    [acq, m2_fixated,trial_rec.gaze_triggered_delay.fix_state_actor,trial_rec.gaze_triggered_delay.fix_state_signaler] = state_gaze_triggered_delay( m2_eye_roi, timing.gaze_triggered_delay, is_gaze_trial, timing.gaze_delay_fixation_time );
...
function [res, m1_ever_chose, m2_ever_chose,was_m1_correct,was_m2_correct] = state_gaze_triggered_actor_choice()
  ...
  state_duration =timing.enable_gaze_triggered_actor_choice_state_duration;% 2.5; % @TODO
