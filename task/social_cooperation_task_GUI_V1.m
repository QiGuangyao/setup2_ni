%not raeady
function social_cooperation_task_GUI_V1
    % Create the main figure window
    f = figure('Position', [300, 50, 700, 650], 'Name', 'Social Cooperation Task Parameters V1');
    ...
    initial_fixation_state_duration_edit = uicontrol('Style', 'edit', 'Position', [col1_x + label_width, y_start - 5 * (height + padding), input_width, height], 'String', '2');
    ...
    initial_reward_m1_edit = uicontrol('Style', 'edit', 'Position', [col1_x + label_width, y_start - 9 * (height + padding), input_width, height], 'String', '0.1');
    ...
    initial_reward_m2_edit = uicontrol('Style', 'edit', 'Position', [col1_x + label_width, y_start - 10 * (height + padding), input_width, height], 'String', '0.1');
    ...
    init_reward_m1_m2_edit = uicontrol('Style', 'edit', 'Position', [col1_x + label_width, y_start - 11 * (height + padding), input_width, height], 'String', '0.1');
    ...
    uicontrol('Style', 'text', 'Position', [col1_x, y_start - 13 * (height + padding), label_width, height], 'String', 'Block Duration (s):', 'HorizontalAlignment', 'left');
    block_duration_edit = uicontrol('Style', 'edit', 'Position', [col1_x + label_width, y_start - 13 * (height + padding), input_width, height], 'String', '300');
    ...
    name_of_m1_edit = uicontrol('Style', 'edit', 'Position', [col2_x + label_width, y_start, input_width, height], 'String', 'M1_tara');
    ...
    name_of_m2_edit = uicontrol('Style', 'edit', 'Position', [col2_x + label_width, y_start - (height + padding), input_width, height], 'String', 'M2_lynch');
    ...
    max_num_trials_edit = uicontrol('Style', 'edit', 'Position', [col2_x + label_width, y_start - 10 * (height + padding), input_width, height], 'String', '50');
...
%     play_feedback_sound_edit = uicontrol('Style', 'edit', 'Position', [col2_x + label_width, y_start - 11 * (height + padding), input_width, height], 'String', 1);
    ...
    proj_p_edit = uicontrol('Style', 'edit', 'Position', [col2_x + label_width, y_start - 12 * (height + padding), input_width*2, height], 'String', 'D:\tempData\cooperation');


    uicontrol('Style', 'text', 'Position', [col2_x, y_start - 13 * (height + padding), label_width, height], 'String', 'Block type:', 'HorizontalAlignment', 'left');
    block_type_edit = uicontrol('Style', 'edit', 'Position', [col2_x + label_width, y_start - 13 * (height + padding), input_width*2, height], 'String', 1);
    ...
    function startTaskCallback(~, ~)
        ...
        block_duration = str2double(get(block_duration_edit, 'String'));
        ...
        block_type = str2double(get(block_type_edit, 'String'));
        ...
        disp(['Error Duration: ', num2str(block_duration)]);
        ...
        disp(['Block type: ', num2str(block_type)]);
        
        % Call the task function with the parameters
        social_cooperation_task_V1(useEyeROI, m2_eye_roi_padding_x, m2_eye_roi_padding_y, ...
            ...
            initial_reward_m2, init_reward_m1_m2, error_duration, block_duration, name_of_m1, ...
