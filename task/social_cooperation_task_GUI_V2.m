%not raeady
function social_cooperation_task_GUI_V2
    % Create the main figure window
    f = figure('Position', [300, 50, 700, 650], 'Name', 'Social Cooperation Task Parameters V2');
...
%     play_feedback_sound_edit = uicontrol('Style', 'edit', 'Position', [col2_x + label_width, y_start - 11 * (height + padding), input_width, height], 'String', 1);
    ...
    function startTaskCallback(~, ~)
        ...
        social_cooperation_task_V2(useEyeROI, m2_eye_roi_padding_x, m2_eye_roi_padding_y, ...
